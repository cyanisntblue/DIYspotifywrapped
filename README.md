# DIY Spotify Wrapped
Command line tool to display top artists, songs, and albums from a given year or of all time.

This Python program accepts only the downloadable "Spotify Extended Streaming History" which must be [requested from Spotify](https://www.spotify.com/account/privacy/) and can take up to a month to be delivered.
